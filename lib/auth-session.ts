export type AuthUser = {
  ...
  export const AUTH_LEGACY_STORAGE_KEY = "ambigr_auth_user";
  export const AUTH_TOKEN_STORAGE_KEY = "auth_token";
  export const AUTH_CHANGE_EVENT = "ambigr-auth-change";
  export const AUTH_LOGIN_SUCCESS_FLAG = "ambigr-login-success";
